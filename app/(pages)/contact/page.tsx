              ...
              <CardContent className="p-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">phonyo126@gmail.com</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">+959 425 743 536</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">
                      Near City Mark (Thamine) , Mayangone Tsp. Yangon
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">
                      Professional, scalable solutions built with modern
                      technologies
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">
                      30 days of support included with every project
                    </p>
                  </div>
                </div>
              </CardContent>
