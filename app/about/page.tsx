...
import { Code2, Rocket, Shield, Users, Award, Clock, Star, Github, Linkedin, Twitter } from "lucide-react"
...
export default function AboutPage() {
  ...
  const values = [
    {
      title: "Quality First",
      description: "Every project is thoroughly tested and optimized for production use.",
      icon: Shield,
    },
    {
      title: "Modern Technology",
      description: "We use the latest frameworks and best practices in all our projects.",
      icon: Code2,
    },
    {
      title: "Customer Success",
      description: "Your success is our priority. We provide ongoing support and guidance.",
      icon: Users,
    },
    {
      title: "Fast Delivery",
      description: "Get your projects up and running quickly with our streamlined process.",
      icon: Rocket,
    },
  ]
          ...
          <div className="container mx-auto text-center">
            <div className="hero-content max-w-4xl mx-auto">
              ...
              <p className="text-xl text-white/70 mb-8 leading-relaxed">
                We're a team of passionate developers and designers dedicated to creating premium, production-ready
                applications that help businesses succeed in the digital world. Our mission is to save you months of
                development time while delivering exceptional quality.
              </p>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {stats.map((stat, index) => (
                <Card key={index} className="stat-card bg-white/5 border-white/10 text-center">
        ...
        <section className="py-16 px-6">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-white/70 max-w-2xl mx-auto">The principles that guide everything we do</p>
            </div>
        ...
        <section ref={teamRef} className="py-16 px-6 bg-black/20">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-white/70 max-w-2xl mx-auto">The talented individuals behind DevProjects</p>
            </div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1">
                        {member.skills.map((skill) => (
                          <Badge key={skill} variant="outline" className="border-white/20 text-white/80 text-xs">
                            {skill}
                          </Badge>
                        ))}
                      </div>
        ...
        <section className="py-16 px-6">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-white/70 max-w-2xl mx-auto">How we ensure every project meets the highest standards</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-white font-semibold mb-2">Planning & Design</h3>
                <p className="text-white/70 text-sm">
                  We start with thorough planning and create detailed designs and specifications.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-white/70 text-sm">
                  Our experienced developers build the project using modern technologies and best practices.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-white/70 text-sm">
                  We deliver the complete project with documentation and provide ongoing support.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-6 bg-black/20">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-white/70 max-w-2xl mx-auto">Real feedback from satisfied customers</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="bg-white/5 border-white/10">
                <CardContent className="p-6">
                  ...
                  <p className="text-white/80 mb-4">
                    "The e-commerce platform saved us 6 months of development time. The code quality is exceptional and
              ...
              <Card className="bg-white/5 border-white/10">
                <CardContent className="p-6">
                  ...
                  <p className="text-white/80 mb-4">
                    "Professional, reliable, and delivered exactly what we needed. The dashboard solution exceeded our
                    expectations."
                  </p>
                  <div className="flex items-center">
                    <img
              ...
              <Card className="bg-white/5 border-white/10">
                <CardContent className="p-6">
                  ...
                  <p className="text-white/80 mb-4">
                    "Great communication, fast delivery, and excellent documentation. Will definitely work with them
                    again."
                  </p>
                  <div className="flex items-center">
                    <img
        ...
        <section className="py-16 px-6">
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl text-white/70 mb-8 max-w-2xl mx-auto">
              Let's discuss your project needs and find the perfect solution for your business.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <Button
