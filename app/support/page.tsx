...
import { HelpCircle, MessageCircle, Book, Video, Download, Clock, Search, Mail, Phone, FileText } from "lucide-react"
...
export default function SupportPage() {
  ...
  const resources = [
    ...
    },
    {
      ...
      description: "Watch detailed walkthroughs of project setup and customization",
      icon: Video,
      link: "#",
      badge: "Popular",
    },
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/support" className="text-purple-400 font-semibold">
                Support
              </Link>
            </div>
          </div>
          ...
          <div className="container mx-auto text-center">
            <div className="hero-content max-w-4xl mx-auto">
              ...
              <p className="text-xl text-white/70 mb-8">
                Get help with your projects, find answers to common questions, and access comprehensive documentation.
              </p>
        ...
        <section className="py-16 px-6 bg-black/20">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Quick Help</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="support-card bg-white/5 border-white/10 hover:bg-white/10 transition-all duration-300 group">
                <CardHeader className="text-center">
                  ...
                  <CardDescription className="text-white/70">Common questions and answers</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="support-card bg-white/5 border-white/10 hover:bg-white/10 transition-all duration-300 group">
                <CardHeader className="text-center">
                  ...
                  <CardDescription className="text-white/70">Get instant help from our team</CardDescription>
                </CardHeader>
                <CardContent>
                  <Button variant="outline" className="w-full border-white/20 text-white hover:bg-white/10">
                    Start Chat
              ...
              <Card className="support-card bg-white/5 border-white/10 hover:bg-white/10 transition-all duration-300 group">
                <CardHeader className="text-center">
                  ...
                  <CardDescription className="text-white/70">Send us a detailed message</CardDescription>
                </CardHeader>
                <CardContent>
                  <Button variant="outline" className="w-full border-white/20 text-white hover:bg-white/10">
                    Send Email
              ...
              <Card className="support-card bg-white/5 border-white/10 hover:bg-white/10 transition-all duration-300 group">
                <CardHeader className="text-center">
                  ...
                  <CardDescription className="text-white/70">Call us for urgent issues</CardDescription>
                </CardHeader>
                <CardContent>
                  <Button variant="outline" className="w-full border-white/20 text-white hover:bg-white/10">
                    Call Now
        ...
        <section className="py-16 px-6 bg-black/20">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-white/70 max-w-2xl mx-auto">
                Find answers to the most common questions about our projects and services
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              {filteredFaqs.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-white/60">Try adjusting your search terms or browse all FAQs.</p>
                </div>
              )}
            </div>
          </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) => setTicketForm({ ...ticketForm, project: value })}
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="dashboard">SaaS Dashboard</SelectItem>
                            <SelectItem value="backend">Mobile App Backend</SelectItem>
        ...
        <section className="py-16 px-6 bg-black/20">
          <div className="container mx-auto">
            <div className="text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-8">Support Hours</h2>
